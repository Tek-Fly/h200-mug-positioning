...
from ..control.manager.notifier import WebSocketNotifier, NotificationTopic, NotificationPriority
...
class EnhancedNotifier:
    ...
    def _map_severity_to_ws_priority(self, severity: AlertSeverity) -> NotificationPriority:
...
async def main():
    ...
    try:
        ...
        print(f"Channel test results: {test_results}")
