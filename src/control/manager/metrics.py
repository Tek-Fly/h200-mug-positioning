...
class MetricsCollector:
    ...
    def record_system_metrics(self, system: SystemResources):
        ...
        # Calculate network throughput (would need previous values in real impl)
        # For now, just record current counters
        self.metrics["system"]["network_throughput_in"].add_point(0)  # TODO: Calculate
        self.metrics["system"]["network_throughput_out"].add_point(0)  # TODO: Calculate
    ...
    def get_server_metrics(self, server_id: str) -> ServerMetrics:
        ...
        return ServerMetrics(
            ...
            memory_used_mb=0,  # TODO: Get from system metrics
            # Request metrics
            ...
            # Model metrics
            model_load_time_ms=self.metrics["model"]["model_load_time"].get_statistics(300)["avg"],
            inference_time_ms=self.metrics["model"]["inference_time"].get_statistics(300)["avg"],
            cache_hit_rate=self.metrics["model"]["cache_hit_rate"].get_statistics(300)["avg"] / 100,
        )
