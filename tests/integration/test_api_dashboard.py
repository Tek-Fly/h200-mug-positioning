...
class TestDashboardAPI(APITestBase, IntegrationTestBase):
    ...
    def test_get_dashboard_overview(self, test_client, auth_headers):
        ...
        with patch('src.control.manager.orchestrator.get_orchestrator') as mock_get_orch:
            ...
            required_fields = [
                "system_status", "active_servers", "recent_analyses",
                "model_status", "cache_stats"
            ]
    ...
    def test_get_system_metrics(self, test_client, auth_headers):
        ...
        with patch('src.control.manager.metrics.get_system_metrics') as mock_get_metrics:
    ...
    def test_get_performance_charts(self, test_client, auth_headers):
        ...
        with patch('src.control.manager.metrics.get_performance_chart_data') as mock_get_charts:
    ...
    def test_get_activity_feed(self, test_client, auth_headers):
            ...
            "activities": [
                {
                    ...
                    "details": {"analysis_id": "analysis_123", "processing_time_ms": 245}
                },
                {
                    "id": "activity_2",
        ...
        with patch('src.control.manager.metrics.get_activity_feed') as mock_get_activities:
    ...
    def test_get_server_status(self, test_client, auth_headers):
        ...
        with patch('src.control.manager.orchestrator.get_orchestrator') as mock_get_orch:
            ...
            response = test_client.get(
                f"{self.base_url}/dashboard/servers",
                headers=auth_headers
            )
    ...
    def test_get_model_performance(self, test_client, auth_headers):
        ...
        with patch('src.control.manager.metrics.get_model_performance') as mock_get_model_perf:
            mock_get_model_perf.return_value = mock_model_perf
            
            response = test_client.get(
                f"{self.base_url}/dashboard/models/performance",
                headers=auth_headers
            )
...
class TestDashboardWebSocket(IntegrationTestBase):
    ...
    def test_websocket_connection(self, test_client):
        ...
        with patch('src.control.api.routers.websocket.ConnectionManager') as mock_manager_class:
