...
class MockMongoCursor:
    ...
    def __init__(self, data, filter_dict=None, projection=None, sort=None, limit=None, skip=None):
        self._data = data
...
def mock_mongodb_with_data(mock_mongodb, sample_analysis_data, sample_rule_data):
    ...
    try:
        loop.run_until_complete(
            db.analyses.insert_one(sample_analysis_data)
        )
        loop.run_until_complete(
            db.rules.insert_one(sample_rule_data)
        )
